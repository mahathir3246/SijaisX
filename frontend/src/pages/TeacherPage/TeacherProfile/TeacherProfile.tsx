...
import { Header, Loader,Content,toaster,Message, Button, Panel, Form, Input, Footer } from 'rsuite';
...
import TeacherFooter from '../layout/Footer';
...
const TeacherProfile = () => {
  ...
  if (loading) {
  return (
    <Panel bordered className="profileContainer">
