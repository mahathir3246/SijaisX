...
export function cardContents(SubstitutionList: SubstitutionBE[], status: 'Available' | 'Applied' | 'Accepted'): SubstitutionFE[]{
...
const SubstituteJobsCard = ({ apiFunction = get_batch_of_available_assignments_for_substitute }: SubUpcomingsProps) => {
    ...
    const fetchAvailableSubs = async () => {
        try{
            ...
            if (response && response.success){
                let status: 'Available' | 'Applied' | 'Accepted' = 'Available';
...
export default SubstituteJobsCard;