...
import { Button, Table, Panel, Content, Loader } from 'rsuite';
...
import SubFooter from "../../../layout/Footer";
...
const SubstituteJobListTable = ({ apiFunction = get_batch_of_available_assignments_for_substitute }: SubUpcomingsProps) => {
    ...
    const [title, setTitle] = useState("My available jobs")
